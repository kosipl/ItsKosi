        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {venues.map((venue, index) => (
            <motion.div
              ...
              className="group relative py-6 px-4 border-b border-hairline hover:border-brand transition-colors duration-300"
            >
              <h3 className="font-body text-xl font-medium text-ink group-hover:translate-x-2 group-hover:text-brand transition-all duration-300">
                {venue}
              </h3>
              <div className="absolute bottom-0 left-0 h-[2px] bg-brand w-0 group-hover:w-full transition-all duration-300" />
            </motion.div>
          ))}
        </div>
      </motion.div>
